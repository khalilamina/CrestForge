...
#[derive(Debug)]
pub struct CrestForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CrestForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CrestForge processing");
    
    let mut processor = CrestForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CrestForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CrestForgeProcessor::new(false);
